...
Game.registerExpedition(function (host) {
  ...
  function report(elapsedMs) {
    ...
    s.pendingReport = { elapsedMs: elapsedMs, gold: Math.floor(goldRate * seconds * DATA.offline.efficiency + 1e-8),
      ...
      materials: { enhanceStone: stones }, accessories: accessories, monsters: captures, stageIndex: s.currentStage };
  ...
  function harvest() {
    ...
    s.materials.enhanceStone += reward.materials.enhanceStone;
